...
function init(b) {
	...
	$("#pauseBtn").attr('src',"./images/btn_pause.svg");
	hideUIElements();
	var saveState = hextrisStorage.getItem("saveState") || "{}";
