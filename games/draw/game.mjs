...
$('#availability').textContent=client.endpoint?'Rooms hold 3–8 players. Share the invite with your friends; no accounts needed.':'Private rooms are temporarily unavailable. Please try again later.';
