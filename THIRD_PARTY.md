...
- Changes: package relocated from repository root into `games/clumsy-bird/`. Every original file is byte-for-byte unchanged.
...
- Changes (2026-09-23): replace the claim that this host is the official 2048 site with accurate attribution; namespace save keys under `duvera.2048`; add English language metadata and keyboard semantics to existing action links. Gameplay is unchanged.
