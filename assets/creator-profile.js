...
(function () {
  ...
  window.ArcadeCreator = active ? Object.freeze({
    ...
    titles:{'clumsy-bird':'Moosh Flap','2048':'Moosh 2048','hextris':'Moosh Spin','stack':'Moosh Stack','four':'Moosh Four','dash':'Moosh Dash','smash':'Moosh Smash','draw':'Moosh Draw','quiz':'Moosh Quiz Party'},
    palette:{ink:'#173e38',teal:'#155a51',mint:'#c2e5cd',coral:'#ef9279',cream:'#f4f0e7',gold:'#f2cd65'},
    games:{smash:{expressions:{idle:'emote-focus.png',win:'emote-win.png',lose:'emote-sad.png'},sounds:{start:'start',milestone:'milestone',win:'win',lose:'lose'}},dash:{tagline:'Watch the road. Grab the stars.',faces:{run:'emote-focus.png',jump:'emote-surprise.png',hit:'emote-sad.png'},sounds:{start:'start',milestone:'milestone',win:'win',lose:'lose'}},four:{tokens:['emote-focus.png','emote-surprise.png'],expressions:{idle:'emote-focus.png',win:'emote-win.png',lose:'emote-sad.png'},sounds:{start:'start',win:'win',lose:'lose'}},stack:{expressions:{idle:'emote-focus.png',streak:'emote-win.png',lose:'emote-sad.png'},sounds:{start:'start',milestone:'milestone',win:'win',lose:'lose'}}},
    party:{avatars:['emote-focus.png','emote-surprise.png','emote-smile.png','emote-win.png','emote-sad.png','emote-laugh.png'],expressions:{idle:'emote-focus.png',win:'emote-win.png',lose:'emote-sad.png'},sounds:{start:'start',milestone:'milestone',win:'win',lose:'lose'}},
    clips
  }) : null;
